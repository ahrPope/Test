...
public class Level {
	...
	//a list of characters present somewhere in this map
    ...
    public int getYOffset(){
        ...
        int half_heigth = (int) (Game.WINDOW_HEIGHT/Game.SCALE/2);
	...
	private void loadTileMap() {
		//creates an array to hold all the tiles in the map
		tiles  = new Tile[map.getWidth()][map.getHeight()];
		
		int layerIndex = map.getLayerIndex("CollisionLayer");
		
		if(layerIndex == -1) {
			//TODO we can clean this up later with an exception if we want, but because we make this ourselfs will suffice for now
			System.err.println("Map does not have the layer \"ColisionLayer\"");
			System.exit(0);
		}
